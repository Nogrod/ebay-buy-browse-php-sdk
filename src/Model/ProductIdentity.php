...
class ProductIdentity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductIdentity';
    ...
    */
     ...
     * @return $this
     */
    public function setIdentifierType(?string $identifier_type): static
    {
     ...
     * @return $this
     */
    public function setIdentifierValue(?string $identifier_value): static
    {
