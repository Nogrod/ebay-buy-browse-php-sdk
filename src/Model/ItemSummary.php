...
class ItemSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $setters = [
        ...
        'item_origin_date' => 'setItemOriginDate',
    ...
    protected static array $getters = [
        ...
        'item_origin_date' => 'getItemOriginDate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('item_origin_date', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $item_creation_date The date and time when the item listing was created. This value is returned in UTC format (<code>yyyy-MM-ddThh:mm:ss.sssZ</code>), which you can convert into the local time of the buyer.<br><br>This field is always returned with <b>itemSummaries</b>.
     *
     * @return $this
     */
     ...
     * Sets item_end_date
     *
     * @param string|null $item_end_date A timestamp that indicates the date and time a listing is scheduled to end.<br><br>This value is returned in UTC format (<code>yyyy-MM-ddThh:mm:ss.sssZ</code>), which can be converted into the local time of the buyer.
     *
     * @return $this
     */
    ...
    /**
     * Gets item_origin_date
     *
     * @return string|null
     */
    public function getItemOriginDate(): ?string
    {
        return $this->container['item_origin_date'];
    }

    /**
     * Sets item_origin_date
     *
     * @param string|null $item_origin_date The date and time when the listing was first made available. This date will be retained if an item is relisted. This value is returned in UTC format (<code>yyyy-MM-ddThh:mm:ss.sssZ</code>), which you can convert into the local time of the buyer.<br><br>This timestamp is used to sort the response when the <code>sort=newlyListed</code> parameter is used.<br><br>This field is always returned with <b>itemSummaries</b>.
     *
     * @return $this
     */
    public function setItemOriginDate(?string $item_origin_date): static
    {
        if (is_null($item_origin_date)) {
            throw new InvalidArgumentException('non-nullable item_origin_date cannot be null');
        }
        $this->container['item_origin_date'] = $item_origin_date;
