...
class CoreItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CoreItem';
    ...
    */
     ...
     *
     * @param \eBay\Buy\Browse\Model\AvailableCoupon[]|null $available_coupons A list of available coupons for the item.
     *
     * @return $this
     */
     ...
     *
     * @param \eBay\Buy\Browse\Model\ShippingOption[]|null $shipping_options An array of shipping options containers that have the details about cost, carrier, etc. of one shipping option.
     *
     * @return $this
     */
