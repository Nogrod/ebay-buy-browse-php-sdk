...
class ResponsiblePerson implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponsiblePerson';
    ...
    */
     ...
     * Sets company_name
     *
     * @param string|null $company_name The name of the Responsible Person or entity.
     *
     * @return $this
     */
     ...
     * Sets contact_url
     *
     * @param string|null $contact_url The contact URL of the Responsible Person or entity.
     *
     * @return $this
     */
