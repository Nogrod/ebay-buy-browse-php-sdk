...
```php
checkCompatibility($item_id, $content_type, $x_ebay_c_marketplace_id, $accept_language, $compatibility_payload): \eBay\Buy\Browse\Model\CompatibilityResponse
```
...
```php
getItem($item_id, $fieldgroups, $x_ebay_c_enduserctx, $x_ebay_c_marketplace_id, $accept_language): \eBay\Buy\Browse\Model\Item
```
...
```php
getItemByLegacyId($legacy_item_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx, $x_ebay_c_marketplace_id, $accept_language): \eBay\Buy\Browse\Model\Item
```
...
```php
getItems($item_ids, $item_group_ids, $x_ebay_c_enduserctx, $x_ebay_c_marketplace_id, $accept_language): \eBay\Buy\Browse\Model\Items
```
...
[**\eBay\Buy\Browse\Model\Items**](../Model/Items.md)
...
```php
getItemsByItemGroup($item_group_id, $fieldgroups, $x_ebay_c_enduserctx, $x_ebay_c_marketplace_id, $accept_language): \eBay\Buy\Browse\Model\ItemGroup
```
